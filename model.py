...
class YOLO(nn.Module):
    ...
    def forward(self, x):
        ...
        head0_result = self.head0(stage0_output)
        ...
        output = (self.sigmoid(head0_result) + self.sigmoid(head1_result) + self.sigmoid(head2_result) + self.sigmoid(head3_result) + self.sigmoid(head4_result)) / 5  # (N, channels, h_grid, w_grid), channels: x1, y1, w1, h1, conf1, x2, y2, w2, h2, conf2, ..., class1, class2, ...
        return output
